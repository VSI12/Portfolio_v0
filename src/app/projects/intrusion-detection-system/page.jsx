            ...
            <div className={styles.project__features2}>
              <div className={styles.features__tech}>
                ...
                <ul className={styles.features__list}>
                  ...
                  <li>Backend: Flask with JWT-based authentication</li>
                  <li>Machine Learning: scikit-learn with joblib for model deployment.</li>
                  <li>Infrastructure: Docker, Terraform, AWS (CodePipeline, ECS, ECR).</li>
              </ul>
              </div>
