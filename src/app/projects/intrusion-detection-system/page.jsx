        ...
        <div className={styles.tech_stack}>
          ...
          <div className={styles.tech}>
            <div className={styles.tech__icon}>
              <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" height={36} width={36}>
          ...
          <div className={styles.tech}>
            <div className={styles.tech__icon}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><g fill-rule="evenodd">
                ...
                <path d="M11.242 42.36L42.86 60.776V23.941L11.242 5.523zm0 0M77.941 85.375L46.324 66.957v36.82l31.617 18.418zm0 0" fill="#5c4ee5"/></g>
              </svg>
            </div>
            <div className={styles.tech__line}></div>
            <h3 className={styles.tech__title}>
          ...
          <div className={styles.tech}>
            <div className={styles.tech__icon}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" fill="#00ACD3" d="M50.9 52.7h9.8v9.8h-9.8v-9.8zm.8.8h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.4 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1z"/><path fill-rule="evenodd" clip-rule="evenodd" fill="#23C2EE" d="M50.9 41.5h9.8v9.8h-9.8v-9.8zm.8.8h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.4 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm3.1 10.4H72v9.8h-9.8v-9.8zm.8.8h.8v8.1H63v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.4 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1z"/><path fill-rule="evenodd" clip-rule="evenodd" fill="#00ACD3" d="M62.2 41.5H72v9.8h-9.8v-9.8zm.8.8h.8v8.1H63v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.4 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1z"/><path fill-rule="evenodd" clip-rule="evenodd" fill="#23C2EE" d="M62.2 30.2H72V40h-9.8v-9.8zm.8.8h.8v8.1H63V31zm1.5 0h.8v8.1h-.8V31zm1.4 0h.8v8.1h-.8V31zm1.5 0h.8v8.1h-.8V31zm1.5 0h.8v8.1h-.8V31zm1.5 0h.8v8.1h-.8V31z"/><path fill-rule="evenodd" clip-rule="evenodd" fill="#00ACD3" d="M73.5 52.7h9.8v9.8h-9.8v-9.8zm.8.8h.8v8.1h-.8v-8.1zm1.4 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1zm1.5 0h.8v8.1h-.8v-8.1z"/><path fill-rule="evenodd" clip-rule="evenodd" fill="#D4EEF1" d="M48.8 78.3c1.5 0 2.7 1.2 2.7 2.7 0 1.5-1.2 2.7-2.7 2.7-1.5 0-2.7-1.2-2.7-2.7 0-1.5 1.2-2.7 2.7-2.7"/><path fill-rule="evenodd" clip-rule="evenodd" fill="#3A4D54" d="M48.8 79.1c.2 0 .5 0 .7.1-.2.1-.4.4-.4.7 0 .4.4.8.8.8.3 0 .6-.2.7-.4.1.2.1.5.1.7 0 1.1-.9 1.9-1.9 1.9-1.1 0-1.9-.9-1.9-1.9 0-1 .8-1.9 1.9-1.9M1.1 72.8h125.4c-2.7-.7-8.6-1.6-7.7-5.2-5 5.7-16.9 4-20 1.2-3.4 4.9-23 3-24.3-.8-4.2 5-17.3 5-21.5 0-1.4 3.8-21 5.7-24.3.8-3 2.8-15 4.5-20-1.2 1.1 3.5-4.9 4.5-7.6 5.2"/><path fill="#BFDBE0" d="M56 97.8c-6.7-3.2-10.3-7.5-12.4-12.2-2.5.7-5.5 1.2-8.9 1.4-1.3.1-2.7.1-4.1.1-1.7 0-3.4 0-5.2-.1 6 6 13.6 10.7 27.5 10.8H56z"/><path fill="#D4EEF1" d="M46.1 89.9c-.9-1.3-1.8-2.8-2.5-4.3-2.5.7-5.5 1.2-8.9 1.4 2.3 1.2 5.7 2.4 11.4 2.9z"/></svg>
            </div>
            <div className={styles.tech__line}></div>
            <h3 className={styles.tech__title}>
              Docker
            ...
            <div className={styles.project__features1}>
              <div className={styles.features}>
                  ...
                  <ul className={styles.features__list}>
                    <li><span className={styles.bold}>User Authentication:</span> Secure login and personalized storage of classification results.</li>
                    <li><span className={styles.bold}>Data Classification:</span> Process and classify NSL-KDD formatted network traffic data with a machine learning model.</li>
                    <li><span className={styles.bold}>Visualization:</span> Dynamic charts displaying insights like malicious traffic percentages.</li>
                    <li><span className={styles.bold}>Scalability & Security:</span>Scalability & Security: Deployed on AWS, leveraging Docker, Terraform, and AWS ECS Fargate for a fault-tolerant and secure architecture.</li>
                  </ul>
                </div>
            </div>

            <div className={styles.project__features2}>
              <div className={styles.features__tech}>
                <div className={styles.title}>
                  Tech Stack
                </div>
                <ul className={styles.features__list}>
                  <li><span className={styles.bold}>Frontend:</span> Next.js with Tailwind CSS.</li>
                  <li><span className={styles.bold}>Backend:</span> Flask with JWT-based authentication</li>
                  <li><span className={styles.bold}>Machine Learning:</span> scikit-learn with joblib for model deployment.</li>
                  <li><span className={styles.bold}>Infrastructure:</span>Infrastructure: Docker, Terraform, AWS (CodePipeline, ECS, ECR).</li>
              </ul>
              </div>
              <div className={styles.project__links}>
                ...
                <div className={styles.links}>
                  <a href="https://github.com/VSI12/Intrusion-Detection-System" target="_blank" rel="noopener noreferrer" className={styles.link}>
                  ...
                  <a href="https://victoriliya.hashnode.dev/intrusion-detection-system" target="_blank" rel="noopener noreferrer" className={styles.link}>
                    <div className={styles.link__tech}>
                      <div className={styles.tech__icon}>
