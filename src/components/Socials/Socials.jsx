...
import { faDev, faGithub, faLinkedin, faYoutube, faHashnode } from "@fortawesome/free-brands-svg-icons";
    ...
    <div className={styles.floatingWidget}>
      <div className={styles.social}>
        <a href="https://victoriliya.hashnode.dev/" target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon icon={faHashnode} className={styles.icon} />
        </a>
        ...
        <a href="https://www.youtube.com/@victorscodex" target="_blank" rel="noopener noreferrer">
